  ...
  switch (node.type) {
    ...
    case 'product':
      ...
      return Object.assign(Object.create(prototype), {
        ...
        value: operator === '+' ? left.value + right.value : operator === '-' ? left.value - right.value : operator === '*' ? left.value * right.value : ''
      });
    case 'roll':
      var value = 0,
          roll = void 0,
...
module.exports = function (input) {
  return __webpack_require__(0)(__webpack_require__(1).parse(input));
};
...
module.exports = {
  'evaluate': __webpack_require__(0),
